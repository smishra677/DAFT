...
def daft_folder_relations_to_newick(
    folder,
    branch_map_file="DAFT_results_1/branch_map.csv",
...
(A,'./RESULTS/RESULTS/APRIL_19/DAFT_results_Q_4',[('A;','F;')]),
(B,'./RESULTS/RESULTS/APRIL_19/DAFT_results_R_4',[('A;','H;')]),
(B,'./RESULTS/RESULTS/APRIL_19/DAFT_results_S_4',[('H;','A;')]),
...
(C,'./RESULTS/RESULTS/APRIL_19/DAFT_results_T_5',[('C;','H;')]),
...
(C,'./RESULTS/RESULTS/APRIL_19/DAFT_results_QQ_1',[('(V,W);','(N,M);'),('Q;','W;')]),
